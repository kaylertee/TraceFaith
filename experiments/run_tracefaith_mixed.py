...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run TraceFaith on mixed ScienceQA and AI2D examples.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path(__file__).resolve().parents[1] / "results" / "tracefaith_mixed_scienceqa_ai2d_20q",
    )
...
def main() -> None:
    ...
    print(f"Wrote TraceFaith artifacts to {args.output_dir}")
